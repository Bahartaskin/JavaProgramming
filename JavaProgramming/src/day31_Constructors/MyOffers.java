...
public class MyOffers {
    ...
    public static void main(String[] args) {
        ...
        fullTimeOffers.removeIf(e->!e.isFullTime); // removes the offer if the offer is NOT fulltime
        ...
        ArrayList<Offer> itHasBenefits = new ArrayList<>(Arrays.asList(myOffers));
        itHasBenefits.removeIf(i->!i.hasBenefit);
        System.out.println(itHasBenefits.size());

        // to print for example all the local offers
