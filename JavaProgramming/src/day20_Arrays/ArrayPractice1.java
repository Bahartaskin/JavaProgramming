...
public class ArrayPractice1 {
    ...
    public static void main(String[] args) {
        ...
        int[] numbers = {10,20,50,70}; // size 4 (0,1,2,3)
        ...
        int[] scores = new int[5]; // int array with ize of 5

        System.out.println(Arrays.toString(scores)); // [0, 0, 0, 0, 0] we didnt assigned anything tho this array so it gives 0 to each element
