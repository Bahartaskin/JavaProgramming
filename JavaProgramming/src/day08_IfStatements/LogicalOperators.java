...
public class LogicalOperators {
    ...
    public static void main(String[] args) {
        ...
        boolean eligible = creditScore >= 700 && age2 >= 21 && income >= 60000;

        System.out.println(name2 + " is eligible for loan: " + eligible);
        ...
        System.out.println(name4 + " is eligible to be USA citizen: " + isEligible4);
